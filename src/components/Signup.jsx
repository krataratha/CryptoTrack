  ...
  return (
    <div className="card p-6 max-w-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button type="submit" className="w-full rounded-lg px-3 py-2 bg-accent-600/20 border border-accent-600/30 text-accent-300 text-sm hover:bg-accent-600/30">Sign Up</button>
      </form>
      <p className="text-xs text-neutral-400 mt-3">
        ℹ️ You'll be automatically logged in after signup
      </p>
    </div>
  );
}
